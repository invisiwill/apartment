...
module Apartment
  module Tenant
    ...
    def self.redshift_adapter(config)
      adapter = Adapters::RedshiftAdapter
      adapter = Adapters::RedshiftSchemaAdapter if Apartment.use_schemas
      adapter = Adapters::RedshiftSchemaFromSqlAdapter if Apartment.use_sql && Apartment.use_schemas
      adapter.new(config)
    end
  end
  ...
  module Adapters
    ...
    class RedshiftSchemaAdapter < AbstractAdapter
